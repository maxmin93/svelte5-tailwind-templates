<div class="mb-10 w-full">
	...
	<div class="border-stroke items-center justify-between border-b md:flex">
		<div class="mb-6 w-full">
			<h2 class="mb-2 text-2xl font-semibold text-base-content">Sales Analytics</h2>
		...
		<div class="mb-6">
			<button
				class="inline-flex items-center justify-center whitespace-nowrap rounded bg-primary px-5 py-[10px] text-sm font-medium text-primary-content hover:bg-opacity-90"
			>
				Add New Item
				<span class="pl-2">
					<svg
