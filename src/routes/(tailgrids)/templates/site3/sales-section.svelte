<script>
	...
	import { bindRadarChart } from './chartjs-redar.svelte';
...
<div class="w-full">
	...
	<div class="-mx-4 flex flex-wrap">
		...
		<ChartCard
			title="Email Sent"
			description="Detailed data of your email inbox"
			options={[
				{ value: 'monthly', name: 'Monthly' },
				{ value: 'yearly', name: 'Yearly' },
			]}
			chartfn={bindRadarChart}
		/>
		<!-- Content #2 -->
		<ChartCard
			title="Sales Graph"
			description="your total sales data analytics"
			options={[
				{ value: 'thisweek', name: 'This Week' },
				{ value: 'lastweek', name: 'Last Week' },
			]}
			chartfn={bindBarChart}
		/>

		<!-- Content #3 -->
		<div class="w-full px-4 2xl:w-3/12">
			<div class="-mx-4 flex flex-wrap">
				<!-- Content #3-0 -->
				<ScoreCard
				...
				<!-- Content #3-1 -->
				<ScoreCard
					value={scoreItems[1].value}
					description={scoreItems[1].description}
					handler={createDropdownHandle()}
				>
					{#snippet svgIcon()}
						<svg
				...
				<!-- Content #3-2 -->
				<ScoreCard
					value={scoreItems[2].value}
					description={scoreItems[2].description}
					handler={createDropdownHandle()}
				>
					{#snippet svgIcon()}
						<svg
...
<!-- Table -->
<div class="w-full px-4 2xl:w-7/12">
	<div class="border-stroke w-full rounded-lg border bg-base-100">
		<TableCard />
	</div>
</div>
