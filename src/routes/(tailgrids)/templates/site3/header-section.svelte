<script>
	...
	import Avatar5Img from '$lib/assets/site3/images/avatar/image-05.jpg';
</script>
...
<header class="w-full bg-base-100">
	...
	>
		...
		<button
			...
			class="border-stroke absolute left-4 top-1/2 flex h-[46px] w-[46px] -translate-y-1/2 items-center justify-center rounded-lg border border-base-100 bg-base-300 text-base-content hover:bg-opacity-50 xl:hidden"
		>
			<svg
				width="20"
				height="20"
		...
		<div class="ml-8 hidden sm:block">
			<div class="flex items-center">
				<span class="mr-4 text-base-content">
					<svg
						width="20"
						height="20"
						viewBox="0 0 20 20"
				...
				<input
					...
					class="w-full bg-transparent text-base text-base-content outline-none"
				/>
			</div>
		</div>
		...
		<div>
			<div class="flex items-center">
				...
				<div class="mr-5 mt-2 hidden md:block">
					<label class="swap swap-rotate text-base-content hover:text-primary">
						<input
							type="checkbox"
							bind:checked={isDark}
				...
				<div class="mr-5 hidden md:block">
					<a href={undefined} class="text-base-content hover:text-primary">
						<svg
							width="22"
							height="22"
							viewBox="0 0 22 22"
				...
				<!-- Alert -->
				<div class="relative mr-5 hidden md:block">
					<a href={undefined} class="text-base-content hover:text-primary">
						<svg
							width="24"
							height="25"
						...
						>
							...
							<path
								...
								fill="currentColor"
							/>
							<circle cx="17" cy="4" r="3.5" fill="#DC3545" stroke="white" />
						</svg>
					</a>
				</div>
					...
					<a href={undefined} class="text-base-content hover:text-primary">
						...
						>
							...
							<path
								...
								fill="currentColor"
							/>
							<circle cx="22" cy="4" r="3.5" fill="#DC3545" stroke="white" />
						</svg>
					</a>
				</div>
				...
				<div class="group relative">
					<a href={undefined} class="flex items-center">
						<!-- Name & Position -->
						<p class="mr-4 text-right text-sm font-medium text-base-content">
							Thomas Anree
							<span class="block text-xs font-normal text-base-content"> Ux Designer </span>
						</p>
						...
						<img
							src={Avatar5Img}
							alt="avatar"
							class="h-[46px] w-[46px] rounded-full object-cover object-center"
						/>

						<span class="ml-[10px] text-base-content">
							<svg
								width="20"
								height="20"
								viewBox="0 0 20 20"
					...
					<div
						class="invisible absolute right-0 top-[120%] mt-3 w-[200px] space-y-2 rounded bg-base-200 p-3 opacity-0 shadow-card-2 duration-200 group-hover:visible group-hover:top-full group-hover:opacity-100"
					>
						<a
							href={undefined}
							class="block rounded px-4 py-2 text-sm font-medium text-base-content hover:bg-primary hover:text-primary-content"
						>
							Account Settings
						</a>
						<a
