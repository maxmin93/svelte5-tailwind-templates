<script>
	// snippets 선언 이전에 사용되었다는 error 를 제거하려면
	// script 블럭이 있어야 함
	// ==> Variable 'contactFormDeco' is used before being assigned
</script>
		...
		<div class="-mx-4 flex flex-wrap lg:justify-between">
			<div class="w-full px-4 lg:w-1/2 xl:w-6/12">
				...
				<div class="mb-12 max-w-[570px] lg:mb-0">
					<span class="mb-4 block text-base font-semibold text-primary"> Contact Us </span>
					<h2
					...
					<p class="mb-9 text-base leading-relaxed text-body-color">
						...
						ut labore et dolore magna aliqua. Ut enim adiqua minim veniam quis nostrud exercitation
						ullamco
					</p>

					<!-- Our Location of Left side  -->
					<div class="mb-8 flex w-full max-w-[370px]">
						...
						<div class="w-full">
							...
							<p class="text-base text-body-color">99 S.t Jomblo Park Pekanbaru 28292. Indonesia</p>
						</div>
					</div>

					<!-- Phone Number of Left side  -->
					<div class="mb-8 flex w-full max-w-[370px]">
						<div
							class="mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-primary bg-opacity-5 text-primary sm:h-[70px] sm:max-w-[70px]"
						>
					...
					<form>
						<div class="mb-6">
							<input
								...
								class="w-full rounded border border-[#f0f0f0] px-[14px] py-3 text-base text-body-color outline-none focus:border-primary focus-visible:shadow-none"
							/>
						</div>
						<div class="mb-6">
							<input
						...
						<div class="mb-6">
							<textarea
								...
								class="w-full resize-none rounded border border-[#f0f0f0] px-[14px] py-3 text-base text-body-color outline-none focus:border-primary focus-visible:shadow-none"
							></textarea>
						</div>
						<div>
							<button
