...
<section id="bizvideo" class="relative z-10 overflow-hidden bg-primary">
	<div class="container mx-auto">
		...
		<div class="-mx-4 flex flex-wrap">
			<!-- wrapper : Left side (1/2) -->
			<div class="w-full px-4 lg:w-1/2">
				<div class="max-w-[490px] py-[100px] lg:py-[140px]">
					<span class="mb-3 block text-base font-semibold text-white"> Watch Our Intro Video </span>
					<h2 class="mb-6 text-3xl font-bold leading-snug text-white sm:text-4xl md:text-[40px]">
					...
					<a
						href={undefined}
						class="inline-block rounded-full border border-white px-9 py-3 text-base font-medium text-white hover:bg-white hover:text-primary"
					>
						Know More
					</a>
				</div>
		...
		<div class="right-0 top-0 z-10 h-full w-full lg:absolute lg:w-1/2">
			<div class="flex h-full w-full items-center justify-center">
				...
				>
					<!-- 원형 파장 애니메이션 효과 -->
					<span
						class="absolute right-0 top-0 z-[-1] h-full w-full animate-ping rounded-full bg-primary bg-opacity-20 delay-300 duration-1000"
					></span>
					<!-- 동영상 플레이 아이콘 (오른쪽 삼각형) -->
					<svg
						width="23"
