		...
		<div class="-mx-4 flex flex-wrap justify-center">
			...
			<div class="w-full px-4 md:w-1/2">
				...
				>
					<!-- content of card -->
					{@render cardContent({
						imgSrc: Testimonial5Img1,
						name: 'Jason Keys',
						email: 'Founder @ Dreampeet.',
						comment:
			...
			<div class="w-full px-4 md:w-1/2">
				...
				>
					<!-- content of card -->
					{@render cardContent({
						imgSrc: Testimonial5Img3,
						name: 'Dipali Dow',
						email: 'Founder @ Cradow.',
						comment:
							"I believe in lifelong learning and Learn. is a great place to learn from experts. I've learned a lot and recommend it to all my friends and familys.",
					})}
					<!-- deco of card -->
			...
			<div class="w-full px-4 md:w-1/2">
				...
				>
					<!-- content of card -->
					{@render cardContent({
						imgSrc: Testimonial5Img4,
						name: 'John Doe',
						email: 'Founder @ Poettry.',
						comment:
							"I believe in lifelong learning and Learn. is a great place to learn from experts. I've learned a lot and recommend it to all my friends and familys.",
					})}
					<!-- deco of card -->
